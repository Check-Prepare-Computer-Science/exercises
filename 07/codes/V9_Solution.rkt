...
;; Returns: a list of numbers, in which all elements should be
;; sorted that are not in the specified interval
(define (numbersBetween alon lower upper)
  (local
    ...
    (if (< upper lower)
        ...
        ; Reverses the list from descending order to ascending order
